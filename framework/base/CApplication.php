 ...
 * The current {@link getLocale application locale} will be used.
 * @property UCDbConnection $db The database connection.
 * @property CWebUser $user The database connection.
 * @property CClientScript $clientScript User script.
 * @property UCDbHttpSession $session Класс управления сессией.
