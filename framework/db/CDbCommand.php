...
class CDbCommand extends CComponent
{
	...
	protected $_query; //переделано мной с private, так как теперь позволяет управлять значением из классов-детей
	 ...
	 */
	protected function processConditions($conditions) //изменен private га protected, не было доступа из наследника
	{
